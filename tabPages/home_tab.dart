              ...
              ElevatedButton(
                onPressed: ()
                {
                  if(isDriverActive != true) //offline
                    ...
                    //display Toast
                    Fluttertoast.showToast(msg: "Çalışmaya başladın");
                  }
                  else //online
                      {
                    driverIsOfflineNow();
                    ...
                    setState(() {
                      statusText = "Çalışmıyorsun";
                      isDriverActive = false;
                      buttonColor = Colors.grey;
                    });

                    //display Toast
                    Fluttertoast.showToast(msg: "Artık Çalışmıyorsun");
                  }
                },
