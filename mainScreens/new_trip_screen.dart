...
class _NewTripScreenState extends State<NewTripScreen>
{
  ...
  String? buttonTitle = "Müşteriye Ulaştım";
  ...
  Future<void> drawPolyLineFromOriginToDestination(LatLng originLatLng, LatLng destinationLatLng) async
  {
    showDialog(
      context: context,
      builder: (BuildContext context) => ProgressDialog(message: "Lütfen Bekleyiniz...",),
    );
  ...
  updateDurationTimeAtRealTime() async
  {
    if(isRequestDirectionDetails == false)
    {
      ...
      {
        setState(() {
          durationFromOriginToDestination = (directionInformation.duration_value!/60).toStringAsFixed(0) + " dakika";
        });
      }
                    ...
                    ElevatedButton.icon(
                      onPressed: () async
                      {
                        ...
                        if(rideRequestStatus == "accepted")
                        {
                          ...
                          setState(() {
                            buttonTitle = "Hadi Gidelim"; //start the trip
                        ...
                        else if(rideRequestStatus == "arrived")
                        {
                          ...
                          setState(() {
                            buttonTitle = "Yolculuğu Bitir"; //end the trip
